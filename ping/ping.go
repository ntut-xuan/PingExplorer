...
func Ping(addr net.IP, sequenceID int) (queueingDelay float64, e error) {
	...
	if err != nil {
		...
		return 100, errors.New("error on creating connection")
	}
	defer conn.Close()
	...
	if err != nil {
		...
		return 0.1, errors.New("error on marshaling ICMP message")
	}
	...
	if err != nil {
		...
		return 0.1, errors.New("error on sending ICMP message")
	}
	...
	if err != nil {
		...
		return 0.1, errors.New("error on reading ICMP reply")
	}
	...
	if err != nil {
		...
		return 0.1, errors.New("error on parsing ICMP reply")
	}
	...
	default:
		...
		return 0.1, errors.New("unexpected ICMP message type")
	}
}
